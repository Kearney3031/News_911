...
<body>
    ...
    <div class="wrap">
        <ul class="siderbar">
	        ...
	        <li><span>广告管理</span>
	            <ul>
	               <li><a href="" target="mainFrame">添加新广告</a></li>
	               <li><a href="" target="mainFrame">管理广告信息</a></li>
	            </ul>
	        </li>
	        <li><span>商品管理</span>
	            <ul>
	               <li><a href="" target="mainFrame">添加新商品</a></li>
	               <li><a href="" target="mainFrame">管理商品信息</a></li>
	            </ul>
	        </li>
	        <li><span>系统功能操作</span>
	        	<ul>
